package com.example.jetflix.presentation.widget
...
import com.example.jetflix.util.animation.ItemAnimationArgs
import com.example.jetflix.util.animation.animateItem
...
fun VerticalStaggeredGrid(
    ...
    Layout(
        ...
        val itemWidth =
            (constraints.maxWidth - totalColumnSpacing - horizontalPadding) / columnCount
        ...
        val placeables = measurables.mapIndexed { index, measurable ->
            ...
            columnHeights[column] += if (placingToLastRow(
                    index,
                    rowCount,
                    columnCount
                )
        ...
        layout(constraints.maxWidth, height) {
            ...
            placeables.forEachIndexed { index, placeable ->
                ...
                columnY[columnIndex] += if (placingToLastRow(
                        index,
                        rowCount,
                        columnCount
                    )
